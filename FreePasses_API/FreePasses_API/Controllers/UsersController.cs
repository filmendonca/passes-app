...
namespace FreePasses_API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> ReciveEmailResetPassword([FromBody] CustomerEmailViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> CheckValidUser(string id)
        {
            if (ModelState.IsValid)
            {
