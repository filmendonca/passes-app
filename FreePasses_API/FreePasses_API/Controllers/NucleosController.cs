...
namespace FreePasses_API.Controllers
{
    ...
    public class NucleosController : Controller
    {
        ...
        public async Task<IActionResult> UpdateSellerPosition([FromBody] SellerPositionViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> ChangeState([FromBody] ChangeOnlineStateViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> AddInformation([FromBody] NucleoInformationViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> GetNucleoInformation(string id)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> GetFreePassesVendidos(string vendedorId)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> TotalFreePasses(string nuc)
        {
            if (ModelState.IsValid)
            {
